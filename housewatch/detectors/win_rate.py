...
The signature detector. Because we know every game's mean return (RTP) and the
standard deviation of that return, we know exactly how an honest player's results
should be distributed. Over N independent bets the total return has:
